package com.example.spring.recipeapp.bootstrap;

import com.example.spring.recipeapp.domain.*;
import com.example.spring.recipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        UomCreator uomCreator = new UomCreator().invoke();
        UnitOfMeasure eachUom = uomCreator.getEachUom();
        UnitOfMeasure tableSpoonUom = uomCreator.getTableSpoonUom();
        UnitOfMeasure teapoonUom = uomCreator.getTeapoonUom();
        UnitOfMeasure dashUom = uomCreator.getDashUom();
        UnitOfMeasure pintUom = uomCreator.getPintUom();
        UnitOfMeasure cupsUom = uomCreator.getCupsUom();
        CategoriesCreator categoriesCreator = new CategoriesCreator().invoke();
        Category americanCategory = categoriesCreator.getAmericanCategory();
        Category mexicanCategory = categoriesCreator.getMexicanCategory();


        Recipe guacRecipe = getGuacRecipe(eachUom, tableSpoonUom, teapoonUom, dashUom, americanCategory, mexicanCategory);


        //add to return list
        recipes.add(guacRecipe);
        Recipe tacosRecipe = getTacosRecipe(eachUom, tableSpoonUom, teapoonUom, pintUom, cupsUom, americanCategory, mexicanCategory);
    ...
    private Recipe getTacosRecipe(UnitOfMeasure eachUom, UnitOfMeasure tableSpoonUom, UnitOfMeasure teapoonUom, UnitOfMeasure pintUom, UnitOfMeasure cupsUom, Category americanCategory, Category mexicanCategory) {
        //Yummy Tacos
    ...
    private Recipe getGuacRecipe(UnitOfMeasure eachUom, UnitOfMeasure tableSpoonUom, UnitOfMeasure teapoonUom, UnitOfMeasure dashUom, Category americanCategory, Category mexicanCategory) {
        //Yummy Guac
    ...
    private class UomCreator {
        ...
        public UnitOfMeasure getEachUom() {
            return eachUom;
        }

        public UnitOfMeasure getTableSpoonUom() {
            return tableSpoonUom;
        }

        public UnitOfMeasure getTeapoonUom() {
            return teapoonUom;
        }

        public UnitOfMeasure getDashUom() {
            return dashUom;
        }

        public UnitOfMeasure getPintUom() {
            return pintUom;
        }

        public UnitOfMeasure getCupsUom() {
            return cupsUom;
        }

        public UomCreator invoke() {
            //get UOMs
            ...
            teapoonUom = tableSpoonUomOptional.get();
    ...
    private class CategoriesCreator {
        private Category americanCategory;
        private Category mexicanCategory;

        public Category getAmericanCategory() {
            return americanCategory;
        }

        public Category getMexicanCategory() {
            return mexicanCategory;
        }

        public CategoriesCreator invoke() {
            //get Categories
